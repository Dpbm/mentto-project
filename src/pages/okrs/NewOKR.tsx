    ...
    reader.onload = (e) => {
      try {
        ...
        if (jsonData.length > 1) {
          ...
          if (dataRow[1]) form.setValue('description', String(dataRow[1]));
          if (dataRow[2]) form.setValue('objective', String(dataRow[2]));
          if (dataRow[3]) form.setValue('quarter', String(dataRow[3]));
        ...
        <div className="space-y-8">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Upload an Excel file to automatically populate OKR data
              </CardDescription>
            </CardHeader>
            <CardContent>
              {!uploadedFile ? (
